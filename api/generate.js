...
function sectionPrompt(type){
  const typeRules = type === 'specimen'
    ...
    : `This is one section of a student's study notes. Write it EXACTLY like a topper's handwritten revision notes, or how the best teacher writes on the board: short, crisp, and 100% to the point — never like a textbook paragraph or a generic AI summary. Requirements:
